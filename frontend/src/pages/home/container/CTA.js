  ...
  return (
    <>
      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 md:mb-20 lg:place-items-center">
          ...
          <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:col-span-6 lg:order-last">
            <div className="w-3/4 mx-auto relative">
              ...
              <div className="w-1/2 h-1/2 bg-white opacity-[0.1] rounded-lg absolute -bottom-[10%] -left-[8%]"/>
