  ...
  return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
        <div className='mt-10 lg:w-1/2 '>
            <h1 className='font-roboto text-center text-3xl font-bold text-dark-soft md:text-5xl lg:text-4xl xl:text-5xl lg:text-left lg:max-w-[540px]'>Read the most interesting articles</h1>
            <p className='text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left'>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                Proin sed condimentum sapien. Duis pretium ante quis ipsum aliquet congue
            </p>
            <Search className=" lg:mt-6 xl:mt-10 mt-10"/>
